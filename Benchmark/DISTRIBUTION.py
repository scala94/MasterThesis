...
thresoldn = EarnDist[int(len(EarnDist)*0.084)-1]
bracket1 = EarnDist[int(len(EarnDist)*0.2)-1]
bracket2 = np.mean(EarnDist[int(len(EarnDist)*0.5)-1:int(len(EarnDist)*0.6)-1])
bracket3 = EarnDist[int(len(EarnDist)*0.9)-1]
bracket4 = np.mean(EarnDist[int(len(EarnDist)*0.9)-1:int(len(EarnDist))-1])
